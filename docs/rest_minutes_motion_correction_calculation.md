...
Locate the script at ***/projects/standard/faird/shared/code/internal/analytics/compare_matrices_to_assign_networks/calc_min_rest.m***. Open it in MATLAB to understand its workings, including the hard-coded FD threshold. To facilitate the generation of the conc file, execute the command: 
